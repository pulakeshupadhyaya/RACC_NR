...
def load_data(kind,label,j):
    ...
    if(kind == "train"):
        ...
        folder_name = "4095_noisy_randomized_0p008/training/"
    if(kind == "valid"):
        num_examples = [3999,3999,3999,3999]
        folder_name = "4095_noisy_randomized_0p008/validation/"
    if(kind == "test"):
        num_examples = [4800,4800,4800,4800]
        folder_name = "4095_noisy_randomized_0p008/testing/"
...
label_list = ['html','jpeg','pdf','latex']

for j in range(0,4):
	(x_test, y_test) = load_data("test",label_list[j],j)
...
# convert class vectors to binary class matrices
	...
	model = Sequential()
	model = load_model('4095_0p008_my_model_9layer_0pdrop.h5')
	model.load_weights('4095_0p008_my_model_weights_9layer_0pdrop.h5')
